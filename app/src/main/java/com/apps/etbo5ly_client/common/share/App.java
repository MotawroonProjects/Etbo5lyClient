package com.apps.etbo5ly_client.common.share;
...
public class App extends MultiDexApplication {
    public static final String CHANNEL_ID = "etbo5ly_id_1099";
    public static final String CHANNEL_NAME = "etbo5ly_channel";
    ...
    private void createChannel() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            channel.setDescription("etbo5ly channel");
